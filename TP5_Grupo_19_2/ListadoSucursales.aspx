<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListadoSucursales.aspx.cs" Inherits="TP5_Grupo_19_2.WebForm4" %>
    ...
    Listado de Sucursales
        ...
        <tr>
            ...
            <td class="auto-style9">
                ...
                <asp:RangeValidator ID="rvSucursal" runat="server" ControlToValidate="txtSucursal" ErrorMessage="Fuera de rango" MaximumValue="999999999" MinimumValue="1"></asp:RangeValidator>
            </td>
            <td class="auto-style10">
                &nbsp;</td>
                 <td class="auto-style11">
